...
**External Dependency Manager** для Android поставляется в составе пакетов <code>ru.rustore.core-<em>version</em>.tgz</code> и <code>RuStoreUnityReviewSDK-<em>version</em>.unitypackage</code>.
