...
**External Dependency Manager** for Android is included in the packages <code>ru.rustore.core-<em>version</em>.tgz</code> and <code>RuStoreUnityReviewSDK-<em>version</em>.unitypackage</code>.

When installing RuStore plugins via `*.unitypackage`, **External Dependency Manager** does not require a special installation. You can proceed directly to the **External Dependency Manager Setup** section below.

To install from <code>ru.rustore.core-<em>version</em>.tgz</code>, follow these steps:
...
1. Follow the steps in the **External Dependency Manager Setup** section below.
...
#### External Dependency Manager Setup
